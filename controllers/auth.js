...
exports.login = asyncHandler(async (req, res, next) => {
    ...
    if(!user) {
        return next(new ErrorResponse(`Invalid credentiails`, 401));
    }
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    const message = `You are receiving this email because you (or someone else) has requested the reset of a password. Please make a PUR request to: \n\n ${resetUrl}`;
